...
//   private  boolean isSpDefenseActive;
    ...
    Pokemon(int attack, int defense, int speed, String name)
    {
        this();
        this.attack = attack;
...
class FireTypePokemon extends Pokemon {

    private int fire_attack;
    private int fire_defense;
    private int electric_defense;
    private int water_defense;
...
class ElectricTypePokemon extends Pokemon {
